...
# For c++ projects to include OpenCV
#
...
ELSE(WIN32)
    SET(OpenCV2_POSSIBLE_ROOT_DIRS
    	/usr/local/Cellar/opencv/2.2/					# OS X: deafult brew installation for v 2.2
    	/usr/local/Cellar/opencv/2.3/					# OS X: deafult brew installation for v 2.3 (expected future revision)
    	/usr/local/Cellar/opencv/2.4/					# OS X: deafult brew installation for v 2.4	(expected future revision)
        /usr/local                                      # Linux: default dir by CMake
        /usr                                            # Linux
        /opt/local                                      # OS X: default MacPorts location
        /sw/local										# OS X: default fink localtion
        )
ENDIF(WIN32)
...
IF(NOT OpenCV2_FOUND)
 ...
 ELSE(NOT OpenCV2_FOUND)
    message(STATUS "Found OpenCV Include Dirs: ${OpenCV2_INCLUDE_DIRS}")
	message(STATUS "Found OpenCV Libs: ${OpenCV2_LIBRARIES}")
